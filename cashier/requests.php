					...
					<td>
						<div class="w3-dropdown-hover">
							...
							<div class="w3-dropdown-content w3-bar-block  w3-border" style="margin-left: -180px !important;margin-top: -30px !important;">
							  <a href="voucherPrint.php?requests=true&transId=<?php echo $row['id']?>&voucherType=1" class="w3-bar-item w3-button" target="_new">Cash Voucher</a>
							  <a href="voucherPrint.php?requests=true&transId=<?php echo $row['id']?>&voucherType=2" class="w3-bar-item w3-button" target="_new">Check Voucher</a>
							</div>
						  </div>
					</td>
				</tr>
